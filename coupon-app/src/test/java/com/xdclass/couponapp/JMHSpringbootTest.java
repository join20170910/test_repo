...
public class JMHSpringbootTest {
    ...
    public void init(){
        ...
        couponServiceImpl = context.getBean(CouponServiceImpl.class);
    }
    ...
    @Benchmark
    public void test(){
        System.out.println(couponServiceImpl.getCouponList());
    }
    ...
    @Benchmark
    public void testDB(){
        System.out.println(couponServiceImpl.loadCoupon(1));
    }
    ...
    @Benchmark
    public void testMap(){
        System.out.println(couponServiceImpl.getCouponList4Map());
    }
    ...
    public void testCaffeine(){
        System.out.println(couponServiceImpl.getCouponListCaffeine());
    }
